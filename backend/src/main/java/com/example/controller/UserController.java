...
public class UserController {
    ...
    @PostMapping()
    public ResponseEntity<HttpResponse> postUser(@RequestBody @Valid UserDTO userDTO) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<HttpResponse> putUser(@PathVariable Long id, @RequestBody @Valid UserDTO userDTO) {
